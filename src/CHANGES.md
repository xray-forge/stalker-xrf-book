# How XRF differs from vanilla

XRF keeps the Call of Pripyat gameplay model, but replaces the Lua development workflow with typed sources, generated
data, automated checks, and reusable tools.
...
XRF aims to preserve the original plot and baseline behavior. Larger gameplay changes should remain isolated as
